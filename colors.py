...
# Define initial color range for detection (red)
...
while True:
    ...
    if g_mode == 1:
        if len(cnts) > 0:
            ...
            if color_radius > 10:
                ...
                value_x = color_x - 160
                value_y = color_y - 120
                # Bound values to avoid extreme angles
                if value_x > 55:
                    value_x = 55
                elif value_x < -55:
                    value_x = -55
                if value_y > 75:
                    ...
                    value_y = -75
                # Adjust robot attitude based on color position
    ...
    # Highlight the current color mode
